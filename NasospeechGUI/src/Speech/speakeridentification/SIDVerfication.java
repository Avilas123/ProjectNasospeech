 ...
 *
 */
public class SIDVerfication extends javax.swing.JPanel {
    ...
    public SIDVerfication(MainFrame mFrame, String useDir, String fileName, JInternalFrame internalFrame, Ivector ivector) {
        this.mFrame = mFrame;
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            if (n_name.length() == 0 || fName.length() == 0) {
                return;
            }
            ...
            resField.put("wavefile", fName);
            resField.put("mode", "test");
            sendToVerfiedFile(userDir, fName, resField);
    ...
    private void sendToVerfiedFile(String userDir, String newFileName, HashMap mapedValue) {
        try {
            ...
            boolean inserted = new SpeakerMaster(mFrame.getConn()).trainNewSID(mapedValue);



            if (!inserted) {
                javax.swing.JOptionPane.showMessageDialog(this, "unable to insert into database", "Error", javax.swing.JOptionPane.ERROR_MESSAGE);
                return;
            }
            ivector.clearAll();
    ...
    private void loadFields() {
        try {
            ...
            Logger.getLogger(SIDVerfication.class.getName()).log(Level.SEVERE, null, er);
        }
    }
