 ...
 *
 */
public class PlotWaveMFCC extends javax.swing.JPanel implements ActionListener, ControlContext, PlotwaveCommon {
    ...
    private RightClickEventMFCC rightClick;
    ...
    private boolean lineStatus = false;
     ...
     public PlotWaveMFCC(MainFrame mainFrame, AudioInputStream audioStreamArray, String language, ArrayList processedList) {
        initComponents();
        // Create Objects Area
        ...
        rightClick = new RightClickEventMFCC(this);
        ...
        try {
            if (file != null && file.isFile()) {
                try {
                    ...
                    Logger.getLogger(PlotWaveMFCC.class.getName()).log(Level.SEVERE, null, ex);
