 ...
 *
 */
public class PDS_NoiseRemove {

    private String userID;
    private String rootPath;

    public PDS_NoiseRemove(String userID, String rootPath) {
        this.userID = userID;
    ...
    public boolean commandWithAnnotation(ArrayList annotationList, String threshold) {
        ...
        try {
            ...
            System.out.println("Correfsfsdfasdfadsf ");
            phoneRec("./PDS/pds/Executables/noiseatt " + fullPath + " " + userID + ".wav " + threshold);
            ...
            while ((strLine = br.readLine()) != null) {
                ...
                if (strLine.length() > 0) {
                    ...
                    if (strLine.startsWith("2")) {
                        strLine = strLine.replaceFirst("2", "1");
