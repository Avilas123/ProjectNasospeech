 ...
 *
 */
public class PhoneReg_Telugu {

    private String userID;

    public PhoneReg_Telugu(String userID) {
        this.userID = userID;
    }
    ...
    public void runCommand(String rootPath) {
        try {
            ...
            phoneRec("./kwspotter/scripts/phoneRecnew2.sh " + wavefile.getAbsolutePath() + " telugu " + userID);
    ...
    public ArrayList readResultFile() {
        ...
        try {
            ...
            in.close();
            System.out.println("Process Over2");
