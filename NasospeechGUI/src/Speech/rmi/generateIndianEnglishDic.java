...
/**
 *
 * @author Nayan Jyoti Kalita <nayanjyotikalita1990gmail.com>
 */
public class generateIndianEnglishDic {
    private String userID;   // loging userid
    private String rootPath; // home/sid/remote/UserSessionDirectory

    public generateIndianEnglishDic(String userID, String rootPath) {
        this.userID = userID;
    ...
    public static String execCmd(String cmd)  {
        ...
        try {
            ...
            Logger.getLogger(generateIndianEnglishDic.class.getName()).log(Level.SEVERE, null, ex);
        }
