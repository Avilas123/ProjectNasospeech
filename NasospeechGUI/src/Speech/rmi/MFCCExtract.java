...
public class MFCCExtract {
    ...
    public MFCCExtract(String userID) {
        this.userID = userID;
    }
    ...
    public void runCommand(String rootPath) {
        try {
            ...
            mfccExtract("./mfccExtract/runMFCC.sh " + wavefile.getAbsolutePath());
    ...
    private void mfccExtract(String cmd) {
    ...
    public ArrayList readResultFile() {
        ...
        try {
            ...
            FileInputStream fstream = new FileInputStream("mfccExtract/mfcc_output.txt");
    ...
    void runCommandDU(String rootPath) {
        try {
            ...
            mfccExtract("./kwspotter/scripts/phoneRecnew2.sh " + wavefile.getAbsolutePath() + " assamese " + userID);
