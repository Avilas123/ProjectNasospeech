 ...
 *
 */
public class VrasiClientPDS {

    private static VrasInterface stub = null;
    private String userID;

    public VrasiClientPDS() {
    }
    ...
    private boolean setConection() {
        try {
            ...
            try {
                InetAddress address = InetAddress.getByName(sconn.getPdsServer());
                if (!address.isReachable(10000)) {
                    javax.swing.JOptionPane.showMessageDialog(null, "Unable to lookup " + sconn.getPdsServer(), "Error", javax.swing.JOptionPane.ERROR_MESSAGE);
                    return false;
                }
                ...
                javax.swing.JOptionPane.showMessageDialog(null, "Unable to reach " + sconn.getPdsServer(), "Error", javax.swing.JOptionPane.ERROR_MESSAGE);
                return false;

            }

            //Registry reg = LocateRegistry.getRegistry("localhost");
            Registry reg = LocateRegistry.getRegistry(sconn.getPdsServer());
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            VrasiClientPDS vClient = new VrasiClientPDS();
    ...
    public boolean sentToRemote(String fileLocation, String fileName, String filePath) {
        try {
            if (!setConection()) {
                return false;
            }
    ...
    public String processPDSDU(String method, ArrayList annotation, String threshold) {
        String result = null;
        System.out.println("hi");
        try {
            result = stub.processPDSProcessDU(method, "tata", "1.1");
            /*
             if (method.startsWith("Remove silence")) {
             result = stub.processPDSProcess(method, annotation, this.userID, threshold);
             if (result != null) {
