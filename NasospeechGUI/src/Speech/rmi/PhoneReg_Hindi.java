 ...
 *
 */
public class PhoneReg_Hindi {

    private String userID;

    public PhoneReg_Hindi(String userID) {
        this.userID = userID;
    }
    ...
    public void runCommand(String rootPath) {
        try {
            ...
            phoneRec("./kwspotter/scripts/phoneRecnew2.sh " + wavefile.getAbsolutePath() + " hindi " + userID);
        } catch (Exception er) {
    ...
    public ArrayList readResultFile(String userID) {
        ...
        try {
            ...
            FileInputStream fstream = new FileInputStream("kwspotter/misc/temp_" + userID + ".lab");
