 ...
 *
 */
public class VrasiClientMFCC { 

    private static VrasInterface stub = null;
    private String userID;

    public VrasiClientMFCC() {
    }
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            VrasiClientMFCC vClient = new VrasiClientMFCC();
            boolean test = vClient.setRemoteConnection("sdfsd", "phenome.wav");
            System.err.println(test);
        } catch (Exception ex) {
            Logger.getLogger(VrasiClientMFCC.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    /// mfcc
    public List processMFCC(String language) {
    //  System.out.println("LANGUAGE PRINTING fron VCkws: "+language);
        ArrayList result = null;
        try {
            result = stub.processMFCC(language, this.userID);
