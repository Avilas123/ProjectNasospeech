...
public class PDS_SilenceRemove {
    ...
    public boolean commandWithAnnotation(ArrayList annotationList, String threshold) {
        ...
        try {
            ...
            String fullPath = ""; // full path of the input file
            ...
            phoneRec("./PDS/pds/Executables/silenceremoval " + fullPath + " " + userID + ".wav " + threshold);
    ...
    boolean commandWithAnnotationDU(ArrayList annotationList, String threshold) {
        try {
            // Create file 
            File wavefile = new File(rootPath + "/" + userID + "/" + userID + ".wav");
            if (!wavefile.exists()) {
