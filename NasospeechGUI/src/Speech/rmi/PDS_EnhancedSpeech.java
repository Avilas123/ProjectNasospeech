 ...
 *
 */
public class PDS_EnhancedSpeech {

    private String userID;
    private String rootPath;

    public PDS_EnhancedSpeech(String userID, String rootPath) {
        this.userID = userID;
    ...
    public boolean commandWithAnnotation(ArrayList annotationList, String threshold) {
        ...
        try {
            ...
            phoneRec("./PDS/pds/Executables/spenhance " + fullPath + " " + userID + ".wav " + threshold);
            phoneRec("./PDS/pds/Executables/spenhncfixannot " + fullPath + " " + userID + ".wav");
            return true;
