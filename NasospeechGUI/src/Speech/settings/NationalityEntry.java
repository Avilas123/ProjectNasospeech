 ...
 */
public class NationalityEntry extends javax.swing.JPanel {
    ...
    private void cmdSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdSaveActionPerformed
        ...
        if(language.length()==0 || language==null)
            JOptionPane.showMessageDialog(null, "Please enter nationality first","Warning",JOptionPane.WARNING_MESSAGE);
        else
        {
            //add to database
            
            String q = "insert into sid_nationality_master (nationality)values('"+language+"')";
            try {
            ...
            JOptionPane.showMessageDialog(null, "New nationality saved successfully !", "Information", JOptionPane.INFORMATION_MESSAGE);
        }
