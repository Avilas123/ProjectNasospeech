 ...
 */
public class GroupEntry extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Enter Speaker Group");
    ...
    private void cmdSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdSaveActionPerformed
        ...
        String language=txtgroup.getText().trim();
        if(language.length()==0 || language==null)
            JOptionPane.showMessageDialog(null, "Please enter group first","Warning",JOptionPane.WARNING_MESSAGE);
        else
        {
            //add to database
            
            String q = "insert into sid_group_master (group_name)values('"+language+"')";
            try {
            ...
            JOptionPane.showMessageDialog(null, "New group saved successfully !", "Information", JOptionPane.INFORMATION_MESSAGE);
        }
