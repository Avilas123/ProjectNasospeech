 ...
 */
public class ChannelEntry extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Enter Channel (e.g. Radio, Microphone)");
    ...
    private void cmdSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdSaveActionPerformed
        ...
        String language=txtChannel.getText().trim();
        if(language.length()==0 || language==null)
            JOptionPane.showMessageDialog(null, "Please enter channel first","Warning",JOptionPane.WARNING_MESSAGE);
        else
        {
            //add to database
            
            String q = "insert into sid_channel_master (channel)values('"+language+"')";
            try {
            ...
            JOptionPane.showMessageDialog(null, "New channel saved successfully !", "Information", JOptionPane.INFORMATION_MESSAGE);
        }
