...
//(:
    ...
    public void waveDelete(int startSample, int endSample) {
        try {
            ...
            String ann_fileName = Hash.getHashValue(StreamConverter.byteTostream(pWave.streamBytes.getCurrent(), pWave.audioInputStream));
            FindAnnotated findAnnotation = new FindAnnotated(pWave.mainFrame.getConn(), ann_fileName, startMs, endMs);
            ...
            Logger.getLogger(PanelRightClickEvent.class.getName()).log(Level.SEVERE, null, ex + "7");
        }
    }
