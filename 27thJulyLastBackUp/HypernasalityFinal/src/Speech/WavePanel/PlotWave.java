...
public class PlotWave extends javax.swing.JPanel implements ActionListener, ControlContext, PlotwaveCommon {
    ...
    private void initComponents() {
        ...
        pausBtn.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Speech.icons1/pause.png"))); // NOI18N
        ...
        cropBtn.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Speech.icons1/crop-tool-button.png"))); // NOI18N
        cropBtn.setToolTipText("crop");
        cropBtn.setBorderPainted(false);
            ...
            .addGroup(wavePanelLayout.createSequentialGroup()
                ...
                .addGroup(wavePanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(wavePanelLayout.createSequentialGroup()
                        .addGroup(wavePanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(wavePanelLayout.createSequentialGroup()
                                .addComponent(timeLabel, javax.swing.GroupLayout.PREFERRED_SIZE, 479, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(18, 18, 18)
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(cropBtn, javax.swing.GroupLayout.PREFERRED_SIZE, 36, javax.swing.GroupLayout.PREFERRED_SIZE))
            ...
            .addGroup(wavePanelLayout.createSequentialGroup()
                ...
                .addGroup(wavePanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(wavePanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                        .addComponent(pausBtn, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addComponent(captBtn, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addComponent(cropBtn, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
...
//                        loadB.setEnabled(false);
    ...
    public void playSound() {
        try {
            ...
            playBtn.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Speech/Icons/stop.jpg")));
            playBtn.setToolTipText("stop");
    ...
    public void stopSound() {
        try {
            ...
            pausBtn.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Speech/Icons/btn_pause_icon.png")));
            playBtn.setToolTipText("play");
            pausBtn.setToolTipText("pause");
        } catch (Exception er) {
            System.err.println(er);
    ...
    public void pauseSound() {
        try {
            ...
            pausBtn.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Speech/Icons/undo.png")));

            pausBtn.setToolTipText("undo");
        } catch (Exception er) {
            System.err.println(er);
        }
    }
    ...
    public void resumeSound() {
        try {
            ...
            pausBtn.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Speech/Icons/pause.jpg")));
            pausBtn.setToolTipText("pause");
        } catch (Exception er) {
            System.err.println(er);
        }
...
//            loadB.setEnabled(true);
    ...
    private void pausBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_pausBtnActionPerformed
        // TODO add your handling code here:
        if (audioInputStream != null) {
            if (pausBtn.getToolTipText().equals("pause")) {
                pauseSound();
            } else {
                resumeSound();
            }
    ...
    private void captBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_captBtnActionPerformed
        // TODO add your handling code here:
        if (captBtn.getToolTipText().equals("record")) {
                  recordSound();
                  pausBtn.setEnabled(false);
                  playBtn.setEnabled(false);
              } else {
