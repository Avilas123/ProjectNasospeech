...
public class MainFrame extends javax.swing.JFrame {
 ...
 public String returnfilename;
   ...
   returnfilename=plot.getfile();
     //  pppppp= pWave.ReturnFilename();
       System.out.println("filenametabbed pai golu\t"+returnfilename);
       
    }
   /*  MainFrame(PlotWave pwave){
    super();
    
    this.pppppp=pwave.ReturnFilename();
    substring=pWave.abbfilePath;//.substring(76);
    System.out.println("filenametabbed"+this.pppppp);
...
//        screenproperty.toolBar(jToolBar1);
       ...
       // System.out.println("pankaj you got"+MainFrame.this.substring);
       if(x==true){
           System.out.println("good evening\t"+pppppp);
       }
      String xx="";//this.dummyfileopenfunction();
     //String xx=MainFrame.this.pppppp;
    String xx1="";//xx.substring(75);
     ...
     //  jInternalFrame1.setTitle(xx);
      ...
      // jTabbedPane2.add(xx2, jInternalFrame2);
         // String xx2="Hypernasality_result";
        //jTabbedPane2.add(xx2, jInternalFrame2);
...
//        jProgressToolBar.setVisible(false);
   ...
   public void opennewtab()
    ...
    {                  // JComponent tab=new JComponent() {};
                      //  tab.setText("Hypernasality_result");
                     //   mainFrame.jDesktopPane1.add(zoom);
    //    JFrame frame = new JFrame("Hypernasality_results");
  //  frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        
        //screenproperty.mainFrameProperty();
           //screenproperty.WavePanel(frame);
         
        String xx2="Hypernasality_result";
      //  jTabbedPane2.add(xx2,frame);
    JInternalFrame jf2=new JInternalFrame();
    JButton btnClose = new JButton("x");
     screenproperty.mainFrameProperty();
       ((javax.swing.plaf.basic.BasicInternalFrameUI)jf2.getUI()).setNorthPane(null);
       screenproperty.WavePanel(jf2);
       
    // jf2.add(btnClose).
       
       jTabbedPane2.add(xx2, jf2);
       // jTabbedPane2.add(btnClose);
      /*  JButton btnClose = new JButton("x");
        JLabel label=new JLabel(xx2);
        int index = jTabbedPane2.indexOfTab(xx2);
...
jf2.add(label,gbc);
   gbc.gridx++;
gbc.weightx = 0; 
   jf2.add(btnClose,gbc);
   jTabbedPane2.setTabComponentAt(index, jf2);
  // btnClose.addActionListener(myCloseActionHandler);
    */
    ...
    {     ((javax.swing.plaf.basic.BasicInternalFrameUI)jInternalFrame1.getUI()).setNorthPane(null);
        ...
        if(x==true){
                    pppppp=filename;
                    System.out.println("evening\t"+pppppp);
                   }
         screenproperty.mainFrameProperty();
           screenproperty.WavePanel(jInternalFrame1);
       jInternalFrame1.add(pWave);
        jTabbedPane2.add(pppppp.substring(75), jInternalFrame1);
        return filename;

    }
   /* public String dummyfileopenfunction1()
    {   
        String filename = pWave.fileOpenMethod();//  fileOpenMethod();
   ...
   {
      pppppp = MainFrame.this.pppppp;
      System.out.print("filename in the getfile method good morning\t"+pppppp);
      return pppppp;
...
pWave.setZoomOut();        // TODO add your handling code here:
    ...
    private void jOpenActionPerformed(ActionEvent evt) {//GEN-FIRST:event_jOpenActionPerformed
        // TODO add your handling code here:
 //JInternalFrame itnern2=new JInternalFrame();
   //     jTabbedPane2.add("nnnnnnn", jInternalFrame2);        
