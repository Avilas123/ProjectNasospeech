...
//        mf.jProgressToolBar.setLocation((int) (xSize * .57), (getScreenHeight() - 91));
     //   mf.jButton1.setLocation((xSize - 37), (getScreenHeight() - 86));
      //  mf.setLocation(dim.width / 2 - mf.getSize().width / 2, 0);
    }
    ...
    public void WavePanel(JInternalFrame wavePanel) {
        Dimension dim = Toolkit.getDefaultToolkit().getScreenSize();
        int xSize = (int) ((getScreenWidth()) - 30);
       //int ySize = 335;
        // changing the size of the input frame
       int ySize = 250;
       //int ySize = 350;
        wavePanel.setSize(504, ySize);
      wavePanel.setLocation(1, 1);
    }
    ...
    public void addSoundImprovePanel(JInternalFrame frame) {
        ...
        int xSize = (int) ((getScreenWidth()) - 50);
        //int ySize = 300;
        
        int ySize =380;
        //int ySize = 350;
        frame.setSize(xSize, ySize);
        //frame.setLocation(1, 336);
        frame.setLocation(1, 300);
    ...
    public void addSoundKwsPanel(JPanel panel) {
        Dimension dim = Toolkit.getDefaultToolkit().getScreenSize();
        int xSize = (int) ((getScreenWidth()) - 20);
        //int ySize = 270;
        int ySize = 350;
