...
lineChart.addEventHandler(MouseEvent.DRAG_DETECTED, 
  ...
  public void createAudioWaveForm(Stage stage,String filename,double[] samples,int numsamples,Tab tab1,TabPane TP,ScrollPane wavepane,Double sam_freq,double duration ){
             Pane pane=new Pane();
