 ...
 // public  LineChart lineChart ;
  ...
  //  @Override
   ...
   resultpane.setTranslateX(351);
    ...
    RamerDouglasPeuckerFilter rdpf = new RamerDouglasPeuckerFilter(0.001);
        ...
        nfx.tempplot(classStage,filename,fpoints, numsamples, tab1, TP, wavepane, factor, duration, canvas);
