 ...
 * @author nazibur
 */
public class Td2confirmed_debugController extends DesignTemplate implements Initializable {
             ...
             SwingUtilities.invokeLater(new Runnable() {
                 ...
                 public void run() 
                 {
                     ...
                     swingNode.setContent(pw);
                      File fileName=new File("/home/training_module/Text-dependent/"+userNumber+"/"+userNumber+ "_TD2_" + iter +  ".wav");
