...
public class PlotWave extends javax.swing.JPanel implements ActionListener, ControlContext, PlotwaveCommon {
   ...
   // public MainFrame mainFrame;
    ...
    private int graphFromScreen = 10, graphVerticalSize = 95, normalPixcel = 60;
 ...
 //   public RightClickEvent rightClick;
    ...
    private int _MAX_UNDO_REDO_SIZE;

    public PlotWave(AudioInputStream audioStreamArray) {
        initComponents();
        // Create Objects Area
        capture = new Capture();
    ...
    private void initComponents() {
        ...
        loadB.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Speech/Icons/open.jpg"))); // NOI18N
        ...
        captB.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Speech/Icons/record.jpg"))); // NOI18N
        captB.setToolTipText("record");
        captB.setFocusable(false);
        captB.setVisible(false);
        ...
        captB.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                captureVoiceAction(evt);
            }
        });
        jToolBar1.add(captB);

        jButton4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Speech/Icons/cut.png"))); // NOI18N
        ...
        jButton3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Speech/Icons/crop.png"))); // NOI18N
        ...
        jButton6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Speech/Icons/zoom-original-2.png"))); // NOI18N
        ...
        layout.setHorizontalGroup(
            ...
            .addComponent(wavePanel, javax.swing.GroupLayout.PREFERRED_SIZE, 280, javax.swing.GroupLayout.PREFERRED_SIZE)
        );
        layout.setVerticalGroup(
            layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(wavePanel, javax.swing.GroupLayout.PREFERRED_SIZE, 135, javax.swing.GroupLayout.PREFERRED_SIZE)
        );
    ...
    private void playBActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_playBActionPerformed
        ...
        try {
            ...
            if (playback.line != null) {
                if (playback.line.isRunning() || playback.line.isOpen()) {
                    return;
                }
            }
            ...
            if (mousePosX1 != 0 && mousePosX2 != 0) {
                ...
                System.out.println("Ref. StartSamples " + startSample + " EndSamples " + endSample + " FramePix " + frames_per_pixel);

                plotwavform.SelectedAudioWave selectW = new plotwavform.SelectedAudioWave();
                selectW.selectdPortion(streamBytes.getCurrent(), startSample, endSample);

                if (selectW.getSelectedByteArray() == null) {
                    return;
                }
                streamBytes.setSelectedPlay(selectW.getSelectedByteArray());
                selectedPlay = true;
                streamVariable.setSecondStarts(startSample /audioInputStream.getFormat().getFrameRate());
                playSound();
            } else if (mousePosX1 != 0) {

                int inPos = (int) mousePosX1, enPos = (int) ((samplingGraph.getSize().width) - 10);
                ...
                double bytesPerSecond = audioInputStream.getFormat().getFrameSize() * (double) audioInputStream.getFormat().getFrameRate();
                int startTime = ((inPos * frames_per_pixel) * audioInputStream.getFormat().getFrameSize());
                int endTime = ((enPos * frames_per_pixel) * audioInputStream.getFormat().getFrameSize());
              //  System.out.println("CK " + ((inPos *frames_per_pixel) /audioInputStream.getFormat().getFrameRate()) * 1000 + " " + ((enPos *frames_per_pixel) / audioInputStream.getFormat().getFrameRate()) * 1000);
   ...
   private void getSamplingPositions() {
        try {
            int width = samplingGraph.getSize().width;
    ...
    AdjustmentListener adjustmentListener = new AdjustmentListener() {
     ...
     try {
            if (audioInputStream != null) {
                ...
                if (method.startsWith("saved")) {
                 ...
                 //   setfileNameColor(Color.black);

                    plotwavform.StreamConverter.byteTowavefile(streamBytes.getCurrent(), audioInputStream, "conf/workspace/" + fileName);


                } else {

                    String fileName = saveLocation();
                    plotwavform.StreamConverter.byteTowavefile(streamBytes.getCurrent(), audioInputStream, fileName);
     ...
     public void cutWaveFile(boolean method) {
        try {
            ...
            if (mousePosX1 != 0 && mousePosX2 != 0 && audioInputStream != null) {
                ...
                calculatePixcel();
                plotwavform.PixcelConversion pixConversion = new plotwavform.PixcelConversion();
                int startMs = pixConversion.pixcelToMillisecond(getStartPixel(), frames_per_pixel, (int) audioInputStream.getFormat().getFrameRate());
                int endMs = pixConversion.pixcelToMillisecond(getendPixel(), frames_per_pixel, (int) audioInputStream.getFormat().getFrameRate());


                plotwavform.CutAudioWave cutW = new plotwavform.CutAudioWave();
                ...
                String hash_current_name = plotwavform.Hash.getHashValue(plotwavform.StreamConverter.byteTostream(streamBytes.getCurrent(), audioInputStream));
                String hash_new_name = plotwavform.Hash.getHashValue(plotwavform.StreamConverter.byteTostream(cutW.getresultByteArray(), audioInputStream));


                saveFileAsSelected("UNDO", streamBytes.getCurrent());

              //  pWave.setfileNameColor(Color.red);

                streamBytes.setCurrent(cutW.getresultByteArray());

                if (!method) {
                    plotwavform.CutAudioInputStream.setCutWave(null);
                }
                copy_from_ms = 0;
                copy_to_ms = 0;
        ...
        if (task == "UNDO") {
            ...
            try {
                if (audiobytes != null && fileName != null) {
                    plotwavform.StreamConverter.byteTowavefile(audiobytes, audioInputStream, fileName);
                    audiobytes = null;
                }
            } catch (Exception er) {
                System.err.println(er.getMessage());
            ...
            try {
                if (audiobytes != null && task != null) {
                    plotwavform.StreamConverter.byteTowavefile(audiobytes, audioInputStream, task);
                    audiobytes = null;
                }
            } catch (Exception er) {
                System.err.println(er.getMessage());
    ...
    private void calculatePixcel() {
        ...
        if (mousePosX1 > mousePosX2) {
            startPix = (int) mousePosX2;
            endPix = (int) mousePosX1;
        } else {
            startPix = (int)mousePosX1;
            endPix = (int)mousePosX2;
        }
    }
    ...
    public void fileOpenMethod() {
        try {
            ...
            if (fc.showOpenDialog(null) == JFileChooser.APPROVE_OPTION) {
                ...
                String AllToWav_command = allToWav_path + " " + source_file_path + " -O" + convertedFile.getAbsolutePath() + "\\" + wav_file_name + " -S16000";
                try {
    ...
    public void recordSound() {
        try {
            ...
            captB.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Speech/Icons/stop.jpg")));
    ...
    public void stopRecord() {
        try {
            ...
            captB.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Speech/Icons/record.jpg")));
            captB.setToolTipText("record");
        } catch (Exception er) {
            System.err.println(er);
        }
        ...
        if (file != null && file.isFile()) {
            try {
                ...
                if (!(file.getName().toLowerCase().endsWith(".wav"))) {
                    System.out.println("This is not correct formate");
                    return;
                }
    ...
    class SamplingGraph extends JPanel implements Runnable {
        ...
        public void createWaveForm(byte[] audiobyte) {
            ...
            try {
                ...
                int endPaint =jScrollPane1.getViewport().getSize().width;
                int startPaint = jScrollPane1.getHorizontalScrollBar().getValue();
                System.out.println("Starting point of scrollpoint"+startPaint);
                endPaint = (startPaint + endPaint);
                System.out.println("Endpoint point of scrollpoint"+endPaint);
...
//End Bit calcution
        ...
        public void paint(Graphics g) {
            try {
                ...
                int h = d.height - 20;
                int INFOPAD = 15;
                System.out.println("Inside paint w and H "+w + " "+h);
                       ...
                       // timeLabel.setText("Length: " + timeConversion((int) record_duration));
                        ...
                        if (playback.thread != null) {
                            if (mousePosX1 != 0 && mousePosX2 != 0) {
                               ...
                               // timeLabel.setText("File : " + fileNameDis + "        Length : " + timeConversion((int) (streamBytes.getCurrent().length / (audioInputStream.getFormat().getFrameRate() * audioInputStream.getFormat().getFrameSize()))) );
                            ...
                            if (audioInputStream != null) {
                              ...
                              //  timeLabel.setText("File : " + fileNameDis + "        Length : " + timeConversion((int) duration) );
                            }
                        ...
                        if (capture.thread == null) {
                            ...
                            for (int t = startPaint; t < endPaint; t++) {
                                ...
                                if ((t * frames_per_pixel) % format.getFrameRate() < frames_per_pixel) {
                                    ...
                                    totalTD = hD + ":" + mD + ":" + sD;
                                    g2.draw((Line2D) new Line2D.Double(t, h - 20, t, h - 2));
                                    g2.setColor(Color.black);
                                    g2.drawString(totalTD, t, h - 7);
                            ...
                            g2.setColor(Color.RED);
                            g2.drawLine(startPaint, h - 10, endPaint, h - 10);
                        }
    ...
    public class RecordWaveGraph implements Runnable {
        ...
        public void run() {
            try {
                ...
                samplingPanel.setPreferredSize(new java.awt.Dimension((int) (tk.getScreenSize().width * 0.764), graphVerticalSize));
                sg.setSize(new java.awt.Dimension((int) (tk.getScreenSize().width - graphFromScreen), graphVerticalSize));
