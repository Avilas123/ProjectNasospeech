...
public class PlotWave extends javax.swing.JPanel implements ActionListener, ControlContext, PlotwaveCommon {
   ...
   // public RightClickEvent rightClick;
    ...
    private void initComponents() {
       ...
       /// jToolBar1.add(captB);
        ...
        layout.setHorizontalGroup(
            ...
            .addComponent(wavePanel, javax.swing.GroupLayout.PREFERRED_SIZE, 504, javax.swing.GroupLayout.PREFERRED_SIZE)
        );
      ...
      //  rightClick.cutWaveFile(true);
        ...
        try {
            ...
            if (mousePosX1 != 0 && mousePosX2 != 0 && audioInputStream != null) {
                ...
                String hash_current_name = Hash.getHashValue(StreamConverter.byteTostream(streamBytes.getCurrent(), audioInputStream));
                String hash_new_name = Hash.getHashValue(StreamConverter.byteTostream(cutW.getresultByteArray(), audioInputStream));
        ...
        if (task == "UNDO") {
            ...
            try {
                if (audiobytes != null && fileName != null) {
                    StreamConverter.byteTowavefile(audiobytes, audioInputStream, fileName);
                    audiobytes = null;
                }
            } catch (Exception er) {
            ...
            try {
                if (audiobytes != null && task != null) {
                    StreamConverter.byteTowavefile(audiobytes, audioInputStream, task);
                    audiobytes = null;
                }
            } catch (Exception er) {
                System.err.println(er.getMessage());
    ...
    public void captureVoiceAction(java.awt.event.ActionEvent evt) {                                    
        // TODO add your handling code here:
            ...
            if (audioInputStream != null) {
                ...
                if (method.startsWith("saved")) {
                 ...
                 //   setfileNameColor(Color.black);
                    ...
                    StreamConverter.byteTowavefile(streamBytes.getCurrent(), audioInputStream, "conf/workspace/" + fileName);


                } else {

                    String fileName = saveLocation();
                    StreamConverter.byteTowavefile(streamBytes.getCurrent(), audioInputStream, fileName);
                ...
                try {
                    ...
                    while (thread != null) 
                    {
                        ...
                        try {
                            ...
                            FileOutputStream fos2 = new FileOutputStream("/home/training_module/temp.wav",true);
                            fos2.write(data);
                            fos2.close();
                        } catch (Exception e1) 
