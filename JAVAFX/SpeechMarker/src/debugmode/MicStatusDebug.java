...
import static designtemplate.DesignTemplate.snrValue;
...
public class MicStatusDebug extends JPanel implements ActionListener {
    ...
    private final PlayerRef thisPlayer = new PlayerRef() {
        ...
        public void drawDisplay(float[] samples, int svalid) {
            ...
            try {
                ...
                Logger.getLogger(MicStatusDebug.class.getName()).log(Level.SEVERE, null, ex);
        ...
        private void func() throws IOException, InterruptedException {
            ...
            File wavFileName = new File("/home/objectFile/a.wav");
    ...
    private void loadAudio(int setFile) throws UnsupportedAudioFileException, IOException 
    {
        if(setFile==0)
        {
            File selected = new File("/home/check.wav");
   ...
   public void startRecording() 
   {
	 ...
	 */
		...
		AudioSystem.write(audioInputStream, AudioFileFormat.Type.WAVE, wavFile);
                Process p;
                p=Runtime.getRuntime().exec("sox /home/objectFile/a.wav /home/objectFile/a1.wav reverse trim 0 2 reverse");
                p.waitFor();
                
                p=Runtime.getRuntime().exec("/home/objectFile/snrcalculation a1.wav");
                p.waitFor();
                ...
                while((micOutput=br.readLine())!=null)
                {
                      ...
                      snrValue=Float.parseFloat(micOutput);
