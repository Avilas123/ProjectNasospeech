 ...
 * @author nazibur
 */
public class Td2recordController extends DesignTemplate implements Initializable {
    ...
    @FXML
    public void td2Record() throws InterruptedException
    {
        if(usrmode)
        {
            try 
            {
                ...
                loader2.setLocation(DesignTemplate.class.getResource("Td2pause.fxml"));           
                AnchorPane renext= (AnchorPane)loader2.load();                   
                BorderPane border2=DesignTemplate.getRoot();           
                border2.setLeft(renext); 
                Td2pauseController control=loader2.getController();
                String str2="Td2confirmed.fxml";
                countDowntimer("#td2Timeleft",4,str2,"#progress3");
                ...
                Thread thd=new Thread()
                {
                    public void run()
                    {
                        try 
                        {
                            ...
                            recordWavFile("/home/training_module/Text-dependent/"+userNumber+"/"+userNumber+ "_TD2_" + iter +  ".wav",4000);
//System.out.println("phone number is "+phoneNumber);
                       /* remove extension from the wave file*/
                            File extn=new File("/home/training_module/Text-dependent/"+userNumber+"/"+userNumber+ "_TD2_" + iter +  ".wav");
        ...
        else
        {
            ...
            {
                FXMLLoader loader2 = new FXMLLoader();        
                loader2.setLocation(DesignTemplate.class.getResource("Td2pause_debug.fxml"));           
                AnchorPane renext= (AnchorPane)loader2.load();                   
                BorderPane border2=DesignTemplate.getRoot();           
                border2.setLeft(renext); 
                Td2pause_debugController control=loader2.getController();
                String str2="Td2confirmed_debug.fxml";
                countDowntimer("#td2Timeleft",4,str2,"#progress3");
