                        ...
                        public void run() {
                             try 
                             {
                                 ...
                                 else if(Mode.equals("TD"))
                                 {
                                     ...
                                     if(strEnergy2.equals("pass"))
                                     {
                                         p1=Runtime.getRuntime().exec("python /home/scripts/tdExtractMfcc_demo.py "+getTestSpkrId()+" "+testFilePath);
                                         p1.waitFor();
                                         findResult();
                                     }
                                     else
                                 ...
                                 else
                                 {
                                     ...
                                     if(strEnergy2.equals("pass"))
                                     {
                                          p1=Runtime.getRuntime().exec("python /home/scripts/ivect_testing_demo.py  "+getTestSpkrId()+" "+testFilePath);
                                          p1.waitFor();
                                          findResult(); 
                                     }
                                     else
                        ...
                        public void run() {
                             try 
                             {
                                 ...
                                 else if(Mode.equals("TD"))
                                 {
                                     ...
                                     if(strEnergy2.equals("pass"))
                                     {
                                         p2=Runtime.getRuntime().exec("python /home/scripts/tdExtractMfcc_demo.py "+getTestSpkrId()+" "+testFilePath);
                                         p2.waitFor();
                                         findResultDebug();
                                     }
                                     else
                                 ...
                                 else
                                 {
                                     ...
                                     if(strEnergy2.equals("pass"))
                                     {
                                          p2=Runtime.getRuntime().exec("python /home/scripts/ivect_testing_demo.py  "+getTestSpkrId()+" "+testFilePath);
                                          p2.waitFor();
                                          findResultDebug(); 
                                     }
                                     else
