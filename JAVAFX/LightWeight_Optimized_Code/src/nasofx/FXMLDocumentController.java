    ...
    void Zoomfunction(MouseEvent event) {
     ...
     //   System.out.println("value slider"+value);
       // nfx.dozoom(value,wavepane,duration);
        ...
        nfx.zoomin(value,LinePane, duration,wavepane,fpoints,factor,NumSamples);
 ...
 //nfx.setTab(tab1);
  ...
  //  wavepane.setHvalue(10);
    ...
    { 
        ...
        double[] samples = plot.readWaveData(SampleRateConversion );
  ...
  // Function to auto-check the sample rate and tick the menuitem of samplerate
           this.audioInputStream = AudioSystem.getAudioInputStream(new File(SampleRateConversion ));
   ...
   //end of tickmenu function
                   ...
                   int  Checknumsamples=samples.length;               ////(600000-1000000).01   (1000000-3000000).1 .15 .2 .25 .3 .35 .4 .45 .6 .65 .7  
                    ...
                    nfx.drawLine(classStage,wavepane,fpoints,factor,NumSamples,LinePane);
                    }
                    ...
                    {   
                        nfx.drawLine(classStage,wavepane,samples,factor,numsamples,LinePane);
